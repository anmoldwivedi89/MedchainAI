...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CViX6zab.mjs");
...
const manifest = {
  "93e2001d237de6ded4a5f846ec9fd29d2c892a7e2f96b757af79b54c7e21457e": {
    functionName: "analyzeMedicineImage_createServerFn_handler",
    importer: () => import("./analyze.functions-Ctlg3i_N.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DkARapax.mjs"),
    import("./start-CYIjWXHl.mjs"),
